  ...
  <div class="row m-0">
    ...
    <div class="col-md-7" >
      <div class="form">
        ...
        <form class="mt-5" action="{{route('personalInfo')}}" method="post">
          <!-- Email input -->
          @csrf
          <div class="form-outline mb-4">
            <label class="form-label" >First name</label>
            <input type="text" id="" name="first_name" class="form-control" placeholder="Name" required/>
          ...
          <div class="form-outline mb-4">
              ...
              <input type="text" id="" name="second_name" class="form-control" placeholder="Name" required />
              <span class="text-danger">
                @error('second_name')
                {{$message}}
                @enderror
            ...
            <div class="form-outline mb-4">
              ...
              <input type="date" id="" name="dob" class="form-control" required/>
              <span class="text-danger">
                @error('dob')
                {{$message}}
                @enderror
            ...
            <div class="form-outline mb-4 country">
            ...
            <div class="form-outline mb-4 cursex" >
              <div class="sex">
          ...
          <!-- Register buttons -->
            ...
            <div class="text-center mt-3 mb-0 alreadyp" >
